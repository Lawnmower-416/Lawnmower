...
router.get('/map/:mapId', AuthController.MapVerify, MapEditorController.getMap)
...
router.get('/map/:mapId/tilesets', AuthController.TilesetVerify, TilesetEditorController.getTilesetsForMapById)
// Hanldes update a tileset in the database request
router.put('/map/:mapId/tileset/:tilesetId', AuthController.TilesetVerify, TilesetEditorController.updateTileset)
...
router.post('/tag/:tagId', TagsController.createTag)
...
// Tileset Routes
router.get('/tileset', AuthController.TilesetVerify, TilesetEditorController.getATileset)
